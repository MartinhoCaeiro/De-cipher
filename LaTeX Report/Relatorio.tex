...
\begin{figure}[H]
	...
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\end{subfigure}
		\caption{Testes com PlayFair 5x5}
	\end{subfigure}
	\hfill
	\vspace{0.5cm}
	\begin{subfigure}[b]{0.48\textwidth}
		...
		\begin{subfigure}[b]{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{Recursos/playfair_test3.png}
			\caption{Depois da Cifragem}
			\vspace{1cm}
			\label{fig:playfair_bf10}
		\end{subfigure}
		\vspace{0.5cm}
		\begin{subfigure}[b]{\textwidth}
			\centering
			\includegraphics[width=0.9\textwidth]{Recursos/playfair_test4.png}
			\caption{Depois da Decifragem}
			\label{fig:playfair_af10}
		\end{subfigure}
		\caption{Testes com PlayFair 10x10}
	\end{subfigure}
	\caption{Testes com PlayFair (5x5 e 10x10)}
	\label{fig:playfair_test_combined}
\end{figure}
